...
class TheanoLossFunctionsTestSuite(unittest.TestCase):
    ...
    def test_hinge_loss(self):
        ...
        loss = _loss_func_theano.hinge_loss(W, X, Y)
        gradient = _loss_func_theano.hinge_loss_derivatives(W, X, Y)
    ...
    def test_softmax_loss(self):
        ...
        loss = _loss_func_theano.softmax_loss(W, X, Y)
        gradient = _loss_func_theano.softmax_loss_derivatives(W, X, Y)
    ...
    def test_l1_penalty(self):
        ...
        loss = _loss_func_theano.l1_penalty(W)
        gradient = _loss_func_theano.l1_penalty_der(W)
    ...
    def test_l2_penalty(self):
        ...
        loss = _loss_func_theano.l2_penalty(W)
        gradient = _loss_func_theano.l2_penalty_der(W)
